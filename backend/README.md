...
## Project Structure
    ...
    ├── testing_taskmktplac_38786  # Django project configurations
...
1. Clone this repo and `cd testing_taskmktplac_38786`
...
2. Clone this repo and `cd testing_taskmktplac_38786`
